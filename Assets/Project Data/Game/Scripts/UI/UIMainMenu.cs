...
namespace Watermelon
{
    public class UIMainMenu : UIPage
    {
        ...
        public override void Initialise()
        {
            ...
            // Levels are started directly from their map nodes. The old red
            // LEVEL button is intentionally hidden and no longer receives input.
            tapToPlayRect.gameObject.SetActive(false);
