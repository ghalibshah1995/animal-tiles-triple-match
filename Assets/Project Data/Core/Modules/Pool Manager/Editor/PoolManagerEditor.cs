...
namespace Watermelon
{
    ...
    sealed internal class PoolManagerEditor : Editor
    {
        ...
        private void PrepareStyles()
        {
            ...
            Texture warningIconTexture = WatermelonEditor.Styles.GetIcon("icon_warning");
            warningIconGUIContent = new GUIContent(warningIconTexture);


            Texture lockedTexture = WatermelonEditor.Styles.GetIcon("icon_locked");
            lockedIconGUIContent = new GUIContent(lockedTexture);

            Texture unlockedTexture = WatermelonEditor.Styles.GetIcon("icon_unlocked");
