...
namespace Watermelon
{
    ...
    {      
        ...
        {
            string definesLine = PlayerSettings.GetScriptingDefineSymbols(DefineManager.ActiveNamedBuildTarget);
        ...
        private void CacheVariables()
        {
            ...
            string defineLine = PlayerSettings.GetScriptingDefineSymbols(DefineManager.ActiveNamedBuildTarget);
        ...
        {
            PlayerSettings.SetScriptingDefineSymbols(DefineManager.ActiveNamedBuildTarget, definesLine);
        }

        private bool CompareDefines()
        {
            string[] currentDefinesArray = PlayerSettings.GetScriptingDefineSymbols(DefineManager.ActiveNamedBuildTarget).Split(';');
