...
namespace Watermelon
{
    public class DefinesString
    {
        ...
        {
            defineLine = PlayerSettings.GetScriptingDefineSymbols(DefineManager.ActiveNamedBuildTarget);
        ...
        public void ApplyDefines()
        {
            ...
            {
                PlayerSettings.SetScriptingDefineSymbols(DefineManager.ActiveNamedBuildTarget, newDefineLine);
            }
        }
    }
}
